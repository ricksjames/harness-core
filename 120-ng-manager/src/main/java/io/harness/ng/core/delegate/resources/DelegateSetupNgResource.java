...
public class DelegateSetupNgResource {
  ...
  generateNgHelmValuesYaml(@Context HttpServletRequest request,
    ...
    return new RestResponse<>(RestClientUtils.getResponse(
            delegateNgManagerCgManagerClient.generateHelmValuesFile(accountId, orgId, projectId, delegateSetupDetails)));
  }
}
