...
public class GenerateOpenApiSpecCommandTest {
  ...
  public void generatesOpenApiSpec() throws Exception {
    final boolean success = !cli.run(GENERATE_OPENAPI_SPEC, TEST_OPENAPI_JSON).isPresent();
  ...
  public void doNotGeneratesOpenApiSpecIfProvidedMoreThanExpectedParameter() throws Exception {
    final boolean success = !cli.run(GENERATE_OPENAPI_SPEC, TEST_OPENAPI_JSON, "extra-param").isPresent();
    String openApiContent = openApiOutputStream.toString(UTF_8.name());
