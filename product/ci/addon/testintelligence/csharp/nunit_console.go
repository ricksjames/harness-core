...
func NewNunitConsoleRunner(log *zap.SugaredLogger, fs filesystem.FileSystem, factory exec.CmdContextFactory) *nunitConsoleRunner { // nolint:revive
...
func (b *nunitConsoleRunner)  AutoDetectPackages() ([]string, error) {
	return []string{}, errors.New("not implemented")
}

func (b *nunitConsoleRunner) GetCmd(ctx context.Context, tests []types.RunnableTest, userArgs, agentConfigPath string, ignoreInstr, runAll bool) (string, error) {
	/*
	...
	*/
	...
	var cmd string
	pathToInjector := filepath.Join(agentConfigPath, "dotnet-agent", "dotnet-agent.injector.exe")
