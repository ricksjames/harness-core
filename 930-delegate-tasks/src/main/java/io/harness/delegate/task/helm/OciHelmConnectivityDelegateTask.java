    ...
    try {
      ...
      final OciHelmValidationParams ociHelmValidationParams =
          OciHelmValidationParams.builder()
              ...
              .build();
      ConnectorValidationResult ociHelmConnectorValidationResult =
          ociHelmValidationHandler.validate(ociHelmValidationParams, getAccountId());
      ociHelmConnectorValidationResult.setDelegateId(getDelegateId());
      return OciHelmConnectivityTaskResponse.builder()
          .connectorValidationResult(ociHelmConnectorValidationResult)
          .build();
