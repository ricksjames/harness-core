...
@Data
@AllArgsConstructor
public class HelmCommandRequestPrams implements TaskParameters, ActivityAccess, ExecutionCapabilityDemander {
    @NotEmpty
    ...
    public HelmCommandRequestPrams(HelmCommandRequestNG.HelmCommandType helmCommandType, boolean mergeCapabilities) {
    ...
    public List<ExecutionCapability> fetchRequiredExecutionCapabilities(ExpressionEvaluator maskingEvaluator) {
        ...
        if (mergeCapabilities) {
            ...
            //executionCapabilities.add(HelmCommandCapability.builder().build());
        }
        if (gitConfig != null) {
