...
public enum ExecutionNodeType {
  ...
  AZURE_WEBAPP_SLOT_SETUP("AZURE_WEB_APP_SLOT_SETUP", YamlTypes.AZURE_WEBAPP_SLOT_SETUP),
  AZURE_WEBAPP_TRAFFIC_SHIFT("AZURE_WEB_APP_TRAFFIC_SHIFT", YamlTypes.AZURE_WEBAPP_TRAFFIC_SHIFT),
  AZURE_WEBAPP_SWAP_SLOT("AZURE_WEB_APP_SWAP_SLOT", YamlTypes.AZURE_WEBAPP_SWAP_SLOT),
