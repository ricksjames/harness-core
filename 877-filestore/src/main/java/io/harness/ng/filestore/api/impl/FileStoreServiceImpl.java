...
import static io.harness.ng.filestore.entities.NGFile.NGFiles;
...
import static io.harness.ng.filestore.repositories.FileStoreRepositoryCriteriaCreator.createFilesAndFoldersFilterCriteria;
import static io.harness.ng.filestore.repositories.FileStoreRepositoryCriteriaCreator.createFilesFilterCriteria;
import static io.harness.ng.filestore.repositories.FileStoreRepositoryCriteriaCreator.createScopeCriteria;
...
import io.harness.ng.filestore.dto.mapper.EmbeddedUserDTOMapper;
import io.harness.ng.filestore.dto.mapper.FileDTOMapper;
import io.harness.ng.filestore.dto.mapper.FileStoreNodeDTOMapper;
import io.harness.ng.filestore.dto.node.FileStoreNodeDTO;
...
public class FileStoreServiceImpl implements FileStoreService {
  ...
  @Override
  public io.harness.ng.filestore.dto.node.FolderNodeDTO listFolderNodes(@NotNull String accountIdentifier,
      String orgIdentifier, String projectIdentifier,
      @NotNull io.harness.ng.filestore.dto.node.FolderNodeDTO folderNodeDTO) {
  ...
  public Page<FileDTO> listFilesAndFolders(@NotNull String accountIdentifier, String orgIdentifier,
    ...
    Page<io.harness.ng.filestore.entities.NGFile> ngFiles = fileStoreRepository.findAll(criteria, pageable);
    return new PageImpl<>(
  ...
  public Page<FileDTO> listFilesWithFilter(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String filterIdentifier, String searchTerm,
      io.harness.ng.filestore.dto.filter.FilesFilterPropertiesDTO filterProperties, Pageable pageable) {
    ...
    if (isNotEmpty(filterIdentifier)) {
      ...
      filterProperties = (io.harness.ng.filestore.dto.filter.FilesFilterPropertiesDTO) filterDTO.getFilterProperties();
    }
    ...
    Page<io.harness.ng.filestore.entities.NGFile> ngFiles =
        fileStoreRepository.findAllAndSort(criteria, createSortByLastModifiedAtDesc(), pageable);
  ...
  private io.harness.ng.filestore.dto.node.FolderNodeDTO populateFolderNode(
      FolderNodeDTO folderNode, String accountIdentifier, String orgIdentifier, String projectIdentifier) {
    List<io.harness.ng.filestore.dto.node.FileStoreNodeDTO> fileStoreNodes =
        listFolderChildren(accountIdentifier, orgIdentifier, projectIdentifier, folderNode.getIdentifier());
    for (io.harness.ng.filestore.dto.node.FileStoreNodeDTO node : fileStoreNodes) {
  ...
  private List<io.harness.ng.filestore.entities.NGFile> listFilesByParentIdentifierSortedByLastModifiedAt(
  ...
  private boolean deleteFolder(NGFile folder) {
    List<io.harness.ng.filestore.entities.NGFile> childrenFiles = listFilesByParent(folder);
  ...
  private List<io.harness.ng.filestore.entities.NGFile> listFilesByParent(NGFile parent) {
