...
package io.harness.ng.filestore.repositories.custom;
...
public interface FileStoreRepositoryCustom {
   ...
   */
  List<io.harness.ng.filestore.entities.NGFile> findAllAndSort(Criteria criteria, Sort sortBy);
   ...
   */
  Page<io.harness.ng.filestore.entities.NGFile> findAllAndSort(Criteria criteria, Sort sortBy, Pageable pageable);
