...
package io.harness.ng.filestore.dto.mapper;
...
public class FileDTOMapper {
  public io.harness.ng.filestore.entities.NGFile getNGFileFromDTO(FileDTO fileDto) {
    if (fileDto.isFolder()) {
      return io.harness.ng.filestore.entities.NGFile.builder()
  ...
  public FileDTO getFileDTOFromNGFile(io.harness.ng.filestore.entities.NGFile ngFile) {
    if (ngFile.isFolder()) {
      return FileDTO.builder()
          ...
          .createdBy(EmbeddedUserDTOMapper.fromEmbeddedUser(ngFile.getCreatedBy()))
          .lastUpdatedBy(EmbeddedUserDTOMapper.fromEmbeddedUser(ngFile.getLastUpdatedBy()))
          .build();
    }
  ...
  public io.harness.ng.filestore.entities.NGFile updateNGFile(FileDTO fileDto, NGFile file) {
    if (fileDto.isFolder()) {
