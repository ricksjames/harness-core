...
public class FileStoreNodeDTOMapper {
  public io.harness.ng.filestore.dto.node.FileNodeDTO getFileNodeDTO(io.harness.ng.filestore.entities.NGFile ngFile) {
  ...
  public io.harness.ng.filestore.dto.node.FolderNodeDTO getFolderNodeDTO(NGFile ngFile) {
