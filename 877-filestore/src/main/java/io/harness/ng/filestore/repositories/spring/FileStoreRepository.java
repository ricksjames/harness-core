...
package io.harness.ng.filestore.repositories.spring;
...
public interface FileStoreRepository
    extends PagingAndSortingRepository<io.harness.ng.filestore.entities.NGFile, String>, FileStoreRepositoryCustom {
  List<io.harness.ng.filestore.entities.NGFile>
  findByAccountIdentifierAndOrgIdentifierAndProjectIdentifierAndParentIdentifier(
      String accountIdentifier, String orgIdentifier, String projectIdentifier, String parentIdentifier);
  Optional<io.harness.ng.filestore.entities.NGFile>
