...
public interface FileReferenceService {
   ...
   */
  Long countEntitiesReferencingFile(io.harness.ng.filestore.entities.NGFile file);
   ...
   */
  Page<EntitySetupUsageDTO> getReferencedBy(
      SearchPageParams pageParams, io.harness.ng.filestore.entities.NGFile file, EntityType entityType);
