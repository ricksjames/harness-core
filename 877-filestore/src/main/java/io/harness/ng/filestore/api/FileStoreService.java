...
public interface FileStoreService {
   ...
   */
  io.harness.ng.filestore.dto.node.FolderNodeDTO listFolderNodes(@NotNull String accountIdentifier,
      String orgIdentifier, String projectIdentifier, @NotNull FolderNodeDTO folderNodeDTO);
