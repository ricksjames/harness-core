...
public class FileFailsafeServiceImpl implements FileFailsafeService {
  ...
  private final io.harness.ng.filestore.api.FileActivityService fileActivityService;
  ...
  @Override
  public FileDTO saveAndPublish(io.harness.ng.filestore.entities.NGFile ngFile) {
    try {
      return Failsafe.with(transactionRetryPolicy).get(() -> transactionTemplate.execute(status -> {
        io.harness.ng.filestore.entities.NGFile savedNgFile = fileStoreRepository.save(ngFile);
  ...
  @Override
  public FileDTO updateAndPublish(
      io.harness.ng.filestore.entities.NGFile oldNGFile, io.harness.ng.filestore.entities.NGFile newNGFile) {
    try {
      return Failsafe.with(transactionRetryPolicy).get(() -> transactionTemplate.execute(status -> {
        io.harness.ng.filestore.entities.NGFile newNgFile = fileStoreRepository.save(newNGFile);
