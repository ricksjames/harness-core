...
public class FilesFilterPropertiesMapper
    implements FilterPropertiesMapper<io.harness.filestore.dto.filter.FilesFilterPropertiesDTO,
        io.harness.filestore.dto.filter.FilesFilterProperties> {
  @Override
  ...
  public FilterProperties toEntity(FilterPropertiesDTO filterPropertiesDTO) {
    ModelMapper modelMapper = new ModelMapper();
    io.harness.filestore.dto.filter.FilesFilterProperties filterProperties =
        modelMapper.map(filterPropertiesDTO, FilesFilterProperties.class);
