  ...
  public static final ImmutableList<YamlSchemaRootClass> yamlSchemaRegistrars =
      ImmutableList.<YamlSchemaRootClass>builder()
          ...
          .add(YamlSchemaRootClass.builder()
                   ...
                   .build())
          .add(YamlSchemaRootClass.builder()
                   .entityType(EntityType.AZURE_WEBAPP_SLOT_SETUP_STEP)
                   .availableAtProjectLevel(true)
                   .availableAtOrgLevel(false)
                   .availableAtAccountLevel(false)
                   .clazz(AzureWebAppSlotSetupStepNode.class)
                   .yamlSchemaMetadata(YamlSchemaMetadata.builder()
                                           .namespace(SchemaNamespaceConstants.CD)
                                           .modulesSupported(Collections.singletonList(ModuleType.CD))
                                           .yamlGroup(YamlGroup.builder().group(StepCategory.STEP.name()).build())
                   ...
                   .build())
          .add(YamlSchemaRootClass.builder()
                   .entityType(EntityType.AZURE_WEBAPP_TRAFFIC_SHIFT)
                   .availableAtProjectLevel(true)
                   .availableAtOrgLevel(false)
                   .availableAtAccountLevel(false)
                   ...
                   .build())
          .add(YamlSchemaRootClass.builder()
                   .entityType(EntityType.AZURE_WEBAPP_SWAP_SLOT)
                   .availableAtProjectLevel(true)
                   .availableAtOrgLevel(false)
                   .availableAtAccountLevel(false)
                   ...
                   .build())
          .add(YamlSchemaRootClass.builder()
                   .entityType(EntityType.AZURE_WEBAPP_ROLLBACK)
                   .availableAtProjectLevel(true)
                   .availableAtOrgLevel(false)
                   .availableAtAccountLevel(false)
