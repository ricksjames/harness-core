...
public class InfrastructurePlanCreator extends ChildrenPlanCreator<PipelineInfrastructure>{
  @Inject
  ...
  @Override
  public LinkedHashMap<String, PlanCreationResponse> createPlanForChildrenNodes(PlanCreationContext ctx, PipelineInfrastructure infrastructure) {
    LinkedHashMap<String, PlanCreationResponse> planCreationResponseMap = new LinkedHashMap<>();

    YamlNode infraSectionNode = ctx.getCurrentField().getNode();
  ...
  @Override
  public PlanNode createPlanForParentNode(PlanCreationContext ctx, PipelineInfrastructure config, List<String> childrenNodeIds) {
    return null;
  }

  @Override
  public Class<PipelineInfrastructure> getFieldClass() {
    return PipelineInfrastructure.class;
  }

  @Override
  public Map<String, Set<String>> getSupportedTypes() {
    return Collections.singletonMap(YamlTypes.PIPELINE_INFRASTRUCTURE, Collections.singleton(PlanCreatorUtils.ANY_TYPE));
  }
}
