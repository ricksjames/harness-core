...
public class CDCreatorUtils {
  ...
  public Set<String> getSupportedStepsV2() {
    return Sets.newHashSet(StepSpecTypeConstants.K8S_CANARY_DEPLOY, StepSpecTypeConstants.K8S_APPLY,
        ...
        StepSpecTypeConstants.CLOUDFORMATION_ROLLBACK_STACK, StepSpecTypeConstants.AZURE_WEBAPP_SLOT_SETUP,
        StepSpecTypeConstants.AZURE_WEBAPP_TRAFFIC_SHIFT, StepSpecTypeConstants.AZURE_WEBAPP_SWAP_SLOT,
