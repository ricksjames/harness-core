...
public interface WorkflowExecutionService extends StateStatusUpdate {
  ...
  boolean approveOrRejectExecution(String appId, List<String> userGroupIds, ApprovalDetails approvalDetails, ApprovalStateExecutionData approvalStateExecutionData);
