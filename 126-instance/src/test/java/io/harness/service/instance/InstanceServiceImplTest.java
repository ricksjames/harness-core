...
public class InstanceServiceImplTest extends InstancesTestBase {
  ...
  public void softDeleteTest() {
    ...
    verify(instanceRepository, times(1))
        .findAndModify(criteriaArgumentCaptor.capture(), updateArgumentCaptor.capture());
    Criteria criteria = criteriaArgumentCaptor.getValue();
    assertThat(criteria.getKey()).isEqualTo(InstanceKeys.instanceKey);
  }
  ...
  public void getActiveInstancesByInfrastructureMappingIdTest() {
    ...
    when(instanceRepository.getActiveInstancesByInfrastructureMappingId(
             accountIdentifier, orgIdentifier, projectIdentifier, infrastructureMappingId, timestamp))
        .thenReturn(Arrays.asList(instance));
