...
@ApiModel(
    subTypes = {BarrierStepInfo.class, HttpStepInfo.class, FlagConfigurationStepInfo.class,
        CustomApprovalStepInfo.class, HarnessApprovalStepInfo.class, JiraApprovalStepInfo.class,
        JiraCreateStepInfo.class, JiraUpdateStepInfo.class, ShellScriptStepInfo.class, ServiceNowApprovalStepInfo.class,
