...
public class PmsPagerDutyChannelTest extends CategoryTest {
  ...
  public void testToNotificationChannel() {
    ...
    NotificationChannel notificationChannel = pmsPagerDutyChannel.toNotificationChannel(
        accountId, orgId, projectId, templateId, templateData, AmbianceTestUtils.buildAmbiance());
