...
public class PmsExecutionSummaryServiceImpl implements PmsExecutionSummaryService {
  private static final String MATRIX_CHILD_ID = "%s_%s";
  ...
  @Override
  public void addStageNodeInGraphIfUnderStrategy(String planExecutionId, NodeExecution nodeExecution, Update updat1e) {
    if (OrchestrationUtils.isStageNode(nodeExecution)
      ...
      updat1e.pull(PipelineExecutionSummaryEntity.PlanExecutionSummaryKeys.layoutNodeMap + "." + strategyNodeId
              + ".edgeLayoutList.currentNodeChildren",
          stageSetupId);
