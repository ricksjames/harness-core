...
public class K8InitializeServiceUtils {
    ...
    public List<ContainerDefinitionInfo> createServiceContainerDefinitions(StageElementConfig stageElementConfig,
                                                                                  PortFinder portFinder, OSType os) {
    ...
    private ContainerDefinitionInfo createServiceContainerDefinition(CIServiceInfo service, PortFinder portFinder,
                                                                            int serviceIdx, String identifier, OSType os) {
        ...
        return ContainerDefinitionInfo.builder()
                ...
                .containerResourceParams(
                        getServiceContainerResource(service.getResources(), service.getIdentifier()))
    ...
    private ContainerResourceParams getServiceContainerResource(
            ContainerResource resource, String identifier) {
