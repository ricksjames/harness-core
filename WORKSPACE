...
plain_artifacts = [
    ...
    "io.dropwizard:dropwizard-assets:2.0.0",
    "io.dropwizard:dropwizard-auth:2.0.0",
    "io.dropwizard:dropwizard-configuration:2.0.0",
    "io.dropwizard:dropwizard-core:2.0.0",
    "io.dropwizard:dropwizard-http2:2.0.0",
    "io.dropwizard:dropwizard-jackson:2.0.0",
    "io.dropwizard:dropwizard-jersey:2.0.0",
    "io.dropwizard:dropwizard-jetty:2.0.0",
    "io.dropwizard:dropwizard-lifecycle:2.0.0",
    "io.dropwizard:dropwizard-logging:2.0.0",
    "io.dropwizard:dropwizard-metrics-graphite:2.0.0",
    "io.dropwizard:dropwizard-metrics:2.0.0",
    "io.dropwizard:dropwizard-request-logging:2.0.0",
    "io.dropwizard:dropwizard-servlets:2.0.0",
    "io.dropwizard:dropwizard-util:2.0.0",
    "io.dropwizard:dropwizard-validation:2.0.0",
    "io.dropwizard:dropwizard-views-freemarker:2.0.0",
    "io.dropwizard:dropwizard-views-mustache:2.0.0",
    "io.dropwizard:dropwizard-views:2.0.0",
...
maven_install(
    ...
    artifacts = plain_artifacts + amazon_artifacts + powermock_artifacts + [
        ...
        maven_test_artifact("io.dropwizard:dropwizard-testing:2.0.0"),
