...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/ac57c254 \
  && curl -s -L -o client-tools/scm/ac57c254/scm https://app.harness.io/public/shared/tools/scm/release/ac57c254/bin/linux/amd64/scm
else
